...
const API_URL = process.env.REACT_APP_API_URL || process.env.API_URL || "https://paas-backend1.azurewebsites.net/api";
console.log("API_URL", process.env.REACT_APP_API_URL || process.env.API_URL || "https://paas-backend1.azurewebsites.net/api");
